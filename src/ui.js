  ...
  if (v.showPlayHud) {
    ...
    <div data-stop style="position: absolute; top: calc(10px + env(safe-area-inset-top)); right: calc(12px + env(safe-area-inset-right)); z-index: 42; display: flex; flex-direction: column; align-items: flex-end; gap: 6px; pointer-events: auto;">
      <div style="display: flex; gap: 8px;">
        <button data-click="${H(v.onPause)}" aria-label="Duraklat" style="width: 34px; height: 34px; display: flex; align-items: center; justify-content: center; gap: 4px; border: 1px solid rgba(159,176,208,0.3); border-radius: 999px; background: rgba(6,10,24,0.5); backdrop-filter: blur(4px); cursor: pointer; padding: 0;"><span style="display: block; width: 3px; height: 11px; border-radius: 2px; background: #cfd9ee;"></span><span style="display: block; width: 3px; height: 11px; border-radius: 2px; background: #cfd9ee;"></span></button>
        <button data-click="${H(v.onQuitRun)}" aria-label="Çıkış" style="width: 34px; height: 34px; display: flex; align-items: center; justify-content: center; border: 1px solid rgba(255,138,155,0.3); border-radius: 999px; background: rgba(24,6,10,0.5); backdrop-filter: blur(4px); color: #ff8a9b; font-size: 13px; line-height: 1; cursor: pointer; padding: 0;">✕</button>
      </div>
